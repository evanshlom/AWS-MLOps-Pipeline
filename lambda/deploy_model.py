...
def lambda_handler(event, context):
   ...
   try:
       ...
       try:
           ...
           # Delete old endpoint configurations to avoid clutter
           old_config = endpoint_desc.get('EndpointConfigName')
           ...
           # Clean up old config after update starts
           if old_config and old_config != endpoint_config_name:
               try:
                   sagemaker.delete_endpoint_config(EndpointConfigName=old_config)
               except:
